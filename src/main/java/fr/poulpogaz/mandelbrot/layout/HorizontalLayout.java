package fr.poulpogaz.mandelbrot.layout;

import java.awt.*;
import java.util.LinkedHashMap;

import static fr.poulpogaz.mandelbrot.layout.HCOrientation.LEFT;
import static fr.poulpogaz.mandelbrot.layout.HCOrientation.RIGHT;
